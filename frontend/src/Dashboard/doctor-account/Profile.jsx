...
const Profile = ({ doctorData }) => {
  ...
  return (
    <div>
      <h2 className="font-bold text-headingColor text-[24px] leading-9 mb-10">
        Profile Information
      </h2>
            ...
            <div key={index}>
              <div>
                ...
                <button
                  ...
                  className="p-2 text-white bg-red-600 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer"
                >
                  <AiOutlineDelete />
                </button>
              </div>
            ...
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                  ...
                  >
                    <button className="p-2 text-white bg-red-600 rounded-full text-[18px] cursor-pointer mt-6">
                      <AiOutlineDelete />
                    </button>
                  </div>
                </div>
