  ...
  return (
    <div>
      ...
      <form>
        ...
        <div className='mb-5'>
          ...
          {formData.qualifications?.map((item,index) => <div key={index}>
            <div>
              ...
              <button className='p-2 text-white bg-red-600 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer'><AiOutlineDelete/></button>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-5 mt-5">
                <div>
                  ...
                  <input type="position" name='position' value={item.degree} className='form__input'/>
                </div>
                <div>
        ...
        <button className='bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer'>Add Experinces</button>
        </div>
        <div className='mb-5'>
          ...
          {formData.timeSlots?.map((item,index) => <div key={index}>
            <div>
              <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                ...
                <button className='p-2 text-white bg-red-600 rounded-full text-[18px] cursor-pointer mt-6'><AiOutlineDelete/></button>
        ...
        <div className='mt-7'>
          <button type='submit' onClick={updateProfileHandler} className='text-white bg-primaryColor text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg'>Update Profile</button>
        </div>
