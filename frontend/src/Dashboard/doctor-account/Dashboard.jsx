...
const Dashboard = () => {
  // Fixing the interpolation of BASE_URL with backticks
        ...
        {!loading && !error && (
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
            ...
            <div className="lg:col-span-2">
              {/* Checking if data exists and isApproved is pending */}
              {data?.isApproved === "pending" && (
                <div className="flex p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50">
                  ...
                  <div className="ml-3 text-sm font-medium">
                    To get approval please complete your profile. I will review
                    ...
                    <div className="flex items-center gap-4 mb-10">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-[6px]">
                          {/* Displaying Average Rating and Total Ratings */}
